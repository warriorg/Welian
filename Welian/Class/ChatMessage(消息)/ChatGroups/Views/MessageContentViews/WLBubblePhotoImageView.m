...
@interface WLBubblePhotoImageView ()
...
@implementation WLBubblePhotoImageView
...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat triangleSize = 12;//三角形的边长
    CGFloat triangleMarginTop = 6;//三角形距离圆角的距离
    
    CGFloat borderOffset = 1;//阴影偏移量
    ...
    float arcSize = 1.5;//角度的大小
    
    if (self.bubbleMessageType == WLBubbleMessageTypeSending) {
...
//    // 简便起见，这里把圆角半径设置为长和宽平均值的1/10
//    CGFloat radius = 6;
//    CGFloat margin = 11;//留出上下左右的边距
//    
//    CGFloat triangleSize = 10;//三角形的边长
//    CGFloat triangleMarginTop = -4;//三角形距离圆角的距离
//    
//    CGFloat borderOffset = 1;//阴影偏移量
//    UIColor *borderColor = [UIColor blackColor];//阴影的颜色
//    
