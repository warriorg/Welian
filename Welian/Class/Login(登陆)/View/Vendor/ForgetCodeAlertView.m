...
@interface ForgetCodeAlertView() <UITextFieldDelegate>
{
    __block int timeout;
...
@implementation ForgetCodeAlertView
...
#define kButtonBottomOffset 10.0f
        // 手机号
        self.codeTextF = [[AuthCodeTextField alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(detLabel.frame)+10, 260, 40)];
