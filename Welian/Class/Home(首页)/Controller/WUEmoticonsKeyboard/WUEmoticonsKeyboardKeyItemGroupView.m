...
//        self.backgroundImageView = backgroundImageView;
        ...
        UIPageControl *pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - WUEmoticonsKeyboardKeyItemGroupViewPageControlHeight+10, CGRectGetWidth(self.bounds), WUEmoticonsKeyboardKeyItemGroupViewPageControlHeight)];
        ...
        UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 10, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds) - WUEmoticonsKeyboardKeyItemGroupViewPageControlHeight) collectionViewLayout:layout];
        ...
        longPressGestureRecognizer.minimumPressDuration = 0.09;
